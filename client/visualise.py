...
def plot_unfiltered_percentage_by_signature():
    ...
    with plt.style.context('bmh'):
        ...
        #plt.title('[payload experiment] Unfiltered percentage for signed vs no signature + malicious signature websites')
        # plt.show()
...
def plot_measurement_by_category(measurement):
    ...
    with plt.style.context('bmh'):
        ...
        #plt.title('[payload experiment] Average {} for each category'.format(measurement))
        # plt.show()
...
def plot_image_size_differences():
    ...
    with plt.style.context('bmh'):
        ...
        #plt.title('[payload experiment] Average image size for clean vs stegoimages with small payload')
        # plt.show()
        ...
        #plt.title('[payload experiment] Average image size for clean vs stegoimages')
        # plt.show()
