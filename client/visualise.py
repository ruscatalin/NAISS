...
def plot_unfiltered_percentage_by_signature():
    ...
    with plt.style.context('bmh'):
        ...
        # plt.title('[image size experiment] Unfiltered percentage for signed vs no signature + malicious signature websites')
        # plt.show()
...
def plot_measurement_by_category(measurement):
    ...
    with plt.style.context('bmh'):
        ...
        # plt.title('[image size experiment] Average {} for each category'.format(measurement))
        # plt.show()
...
def plot_image_size_differences():
    ...
    with plt.style.context('bmh'):
        ...
        # plt.title('[image size experiment] Average image size for clean vs stegoimages with small payload')
        # plt.show()
        ...
        # plt.title('[image size experiment] Average image size for clean vs stegoimages')
        # plt.show()
